...
az dt twin create `
  --dt-name $dtName `
  --twin-id "room101" `
  --model-id "dtmi:dtframework:smartbuilding:Room;1" `
...
az dt twin create `
  --dt-name $dtName `
  --twin-id "hvac101" `
  --model-id "dtmi:dtframework:smartbuilding:HVACUnit;1" `
...
az dt twin create `
  ...
  --model-id "dtmi:dtframework:smartbuilding:TemperatureSensor;1" `
...
az dt twin create `
  ...
  --model-id "dtmi:dtframework:smartbuilding:CO2Sensor;1" `
  --properties @$co2Props
