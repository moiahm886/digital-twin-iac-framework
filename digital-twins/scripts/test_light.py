...
# Rate: 100 msg/s | Duration: 2 minutes
...
def run():
    ...
    print(f"[Light] Starting — {TARGET_RATE} msg/s for {DURATION_SECONDS}s")
    ...
    while time.time() < end_time:
        ...
        if msg_counter % 100 == 0:
            print(f"[Light] {elapsed:.0f}s elapsed — sent {total_sent} msgs, errors {total_errors}")
